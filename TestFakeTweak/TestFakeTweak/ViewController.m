...
@property (weak, nonatomic) IBOutlet UITextField *sysV;
@property (weak, nonatomic) IBOutlet UISwitch *switch1;
@property (weak, nonatomic) IBOutlet UISwitch *switch2;
@property (weak, nonatomic) IBOutlet UIButton *clsKeyBtn;
@property (weak, nonatomic) IBOutlet UIButton *clsSafari;
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    NSDictionary *infoDict = self.infoArray[1];
    WPFInfo *infoModel = [WPFInfo infoWithDict:infoDict];
    self.nameTF.text = infoModel.infoValue;
    
    NSDictionary *infoDict1 = self.infoArray[0];
    WPFInfo *infoModel1 = [WPFInfo infoWithDict:infoDict1];
    self.versionTF.text = infoModel1.infoValue;
    
    NSDictionary *infoDict6 = self.infoArray[6];
    WPFInfo *infoModel6 = [WPFInfo infoWithDict:infoDict6];
    self.sysV.text = infoModel6.infoValue;
...
- (IBAction)switch1:(id)sender {
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"" message:nil delegate:self cancelButtonTitle:@"ok" otherButtonTitles:nil];
    [alertView show];

}
- (IBAction)switch2:(id)sender {
}
- (IBAction)clsKeyAction:(id)sender {
}
- (IBAction)clsSafariAction:(id)sender {
}
